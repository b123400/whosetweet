...
Elm.TwitterTypes = Elm.TwitterTypes || {};
Elm.TwitterTypes.make = function (_elm) {
   "use strict";
   _elm.TwitterTypes = _elm.TwitterTypes || {};
   if (_elm.TwitterTypes.values) return _elm.TwitterTypes.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var answerCorrect = function (answer) {    return _U.eq(answer.question.tweet.user.screenName,answer.answer.screenName);};
   var Answer = F2(function (a,b) {    return {question: a,answer: b};});
   var Question = F2(function (a,b) {    return {tweet: a,choices: b};});
   var User = F2(function (a,b) {    return {userName: a,screenName: b};});
   var user = A3($Json$Decode.object2,User,A2($Json$Decode._op[":="],"name",$Json$Decode.string),A2($Json$Decode._op[":="],"screen_name",$Json$Decode.string));
   var Tweet = F2(function (a,b) {    return {user: a,text: b};});
   var tweet = A3($Json$Decode.object2,Tweet,A2($Json$Decode._op[":="],"user",user),A2($Json$Decode._op[":="],"text",$Json$Decode.string));
   return _elm.TwitterTypes.values = {_op: _op,tweet: tweet,user: user,answerCorrect: answerCorrect,Tweet: Tweet,User: User,Question: Question,Answer: Answer};
};
Elm.Html = Elm.Html || {};
...
Elm.Asker = Elm.Asker || {};
Elm.Asker.make = function (_elm) {
   "use strict";
   _elm.Asker = _elm.Asker || {};
   if (_elm.Asker.values) return _elm.Asker.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $TwitterTypes = Elm.TwitterTypes.make(_elm);
   var _op = {};
   var answerStyleAttributes = function (state) {
      return $Html$Attributes.$class(function () {
         var _p0 = state;
         switch (_p0.ctor)
   ...
   var buttons = F2(function (choices,getAttribute) {
      return $Array.toList(A2($Array.map,function (user) {    return A2($Html.div,getAttribute(user),_U.list([$Html.text(user.screenName)]));},choices));
   });
   var getResult = function (model) {    var _p1 = model;if (_p1.ctor === "Answered") {    return $Maybe.Just(_p1._0);} else {    return $Maybe.Nothing;}};
   var NotSelected = {ctor: "NotSelected"};
   var Wrong = {ctor: "Wrong"};
   var Correct = {ctor: "Correct"};
   var getChoiceState = F2(function (selected,correct) {
      var _p2 = {ctor: "_Tuple2",_0: selected,_1: correct};
      if (_p2._1 === true) {
            return Correct;
         } else {
            if (_p2._0 === false) {
   ...
   var answerAttributes = F3(function (answered,correct,current) {
      var isCorrect = _U.eq(current.screenName,correct.screenName);
      var isSelected = _U.eq(current.screenName,answered.screenName);
      return _U.list([answerStyleAttributes(A2(getChoiceState,isSelected,isCorrect))]);
   });
   var Reply = function (a) {    return {ctor: "Reply",_0: a};};
   var choiceAttributes = F2(function (address,user) {    return _U.list([A2($Html$Events.onClick,address,Reply(user))]);});
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("asker")]),
      _U.list([function () {
         var _p3 = model;
         if (_p3.ctor === "Asking") {
               var _p4 = _p3._0;
               return A2($Html.div,
               _U.list([]),
               _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("question-text")]),_U.list([$Html.text(_p4.tweet.text)]))
                       ,A2($Html.div,_U.list([$Html$Attributes.$class("choices")]),A2(buttons,_p4.choices,choiceAttributes(address)))]));
            } else {
               var _p5 = _p3._0;
               return A2($Html.div,
               _U.list([]),
               _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("question-text")]),_U.list([$Html.text(_p5.question.tweet.text)]))
                       ,A2($Html.div,
                       _U.list([$Html$Attributes.$class("choices")]),
                       A2(buttons,_p5.question.choices,A2(answerAttributes,_p5.answer,_p5.question.tweet.user)))]));
            }
      }()]));
   });
   var ShowAnswer = function (a) {    return {ctor: "ShowAnswer",_0: a};};
   var ShowQuestion = function (a) {    return {ctor: "ShowQuestion",_0: a};};
   var Answered = function (a) {    return {ctor: "Answered",_0: a};};
   var Asking = function (a) {    return {ctor: "Asking",_0: a};};
   var init = function (question) {    return {ctor: "_Tuple2",_0: Asking(question),_1: $Effects.none};};
   var update = F2(function (action,model) {
      var _p6 = {ctor: "_Tuple2",_0: action,_1: model};
      _v4_3: do {
         if (_p6.ctor === "_Tuple2") {
               switch (_p6._0.ctor)
               {case "ShowQuestion": return {ctor: "_Tuple2",_0: Asking(_p6._0._0),_1: $Effects.none};
                  case "ShowAnswer": return {ctor: "_Tuple2",_0: Answered(_p6._0._0),_1: $Effects.none};
                  default: if (_p6._1.ctor === "Asking") {
                          return {ctor: "_Tuple2",_0: Answered(A2($TwitterTypes.Answer,_p6._1._0,_p6._0._0)),_1: $Effects.none};
                       } else {
                          break _v4_3;
                       }}
            } else {
   ...
   return _elm.Asker.values = {_op: _op,getResult: getResult,init: init,update: update,view: view,Correct: Correct,Wrong: Wrong,NotSelected: NotSelected};
};
Elm.Native.Http = {};
...
Elm.Random.Array.make = function (_elm) {
   ...
   var choose = F2(function (seed,arr) {
      if ($Array.isEmpty(arr)) return {ctor: "_Tuple3",_0: $Maybe.Nothing,_1: seed,_2: arr}; else {
            ...
            var back = _U.eq(index,lastIndex) ? $Array.empty : A3($Array.slice,index + 1,$Array.length(arr),arr);
            return {ctor: "_Tuple3",_0: A2($Array.get,index,arr),_1: seed$,_2: A2($Array.append,front,back)};
         }
   });
   var shuffle = F2(function (seed,arr) {
      if ($Array.isEmpty(arr)) return {ctor: "_Tuple2",_0: arr,_1: seed}; else {
            var helper = function (_p1) {
               ...
               var _p4 = m_val;
               if (_p4.ctor === "Nothing") {
                     return $Trampoline.Done({ctor: "_Tuple3",_0: _p8,_1: _p9,_2: _p7});
                  } else {
                     return $Trampoline.Continue(function (_p5) {
                        var _p6 = _p5;
                        return helper({ctor: "_Tuple3",_0: s$,_1: A2($List._op["::"],_p4._0,_p9),_2: a$});
                     });
                  }
            };
            var _p10 = $Trampoline.trampoline(helper({ctor: "_Tuple3",_0: seed,_1: _U.list([]),_2: arr}));
            var seed$ = _p10._0;
            var shuffled = _p10._1;
            return {ctor: "_Tuple2",_0: $Array.fromList(shuffled),_1: seed$};
         }
   });
   ...
   return _elm.Random.Array.values = {_op: _op,sample: sample,choose: choose,shuffle: shuffle};
};
Elm.Guesser = Elm.Guesser || {};
Elm.Guesser.make = function (_elm) {
   "use strict";
   _elm.Guesser = _elm.Guesser || {};
   if (_elm.Guesser.values) return _elm.Guesser.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Asker = Elm.Asker.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $TwitterTypes = Elm.TwitterTypes.make(_elm);
   var _op = {};
   var tweetButtonSrc = F2(function (marks,total) {
      return A2($Basics._op["++"],
      "https://twitter.com/intent/tweet?text=",
      A2($Basics._op["++"],
      A2($Basics._op["++"],$Basics.toString(total),A2($Basics._op["++"],"位推友裏面我猜中了",A2($Basics._op["++"],$Basics.toString(marks),"個，"))),
      $Http.uriEncode(A2($Basics._op["++"],
      function () {
         var percentage = $Basics.toFloat(marks) / $Basics.toFloat(total);
         return _U.cmp(percentage,0.2) < 0 ? "我完全不了解推友們啊" : _U.cmp(percentage,0.4) < 0 ? "亂猜也中了幾個嘛！" : _U.cmp(percentage,
         0.6) < 0 ? "你們也來試試看猜一下推友喔" : _U.cmp(percentage,0.8) < 0 ? "我還算是滿了解推友們的啦" : _U.cmp(percentage,0.9) < 0 ? "♥我真的很愛推友♥" : "我對推友們簡直瞭如指掌～";
      }(),
      " http://whosetweet.b123400.net #猜推友"))));
   });
   var tweetButton = F2(function (marks,total) {
      return A2($Html.a,
      _U.list([$Html$Attributes.$class("tweet-button"),$Html$Attributes.href(A2(tweetButtonSrc,marks,total)),$Html$Attributes.target("_blank")]),
      _U.list([$Html.text(function () {
         var percentage = $Basics.toFloat(marks) / $Basics.toFloat(total);
         return _U.cmp(percentage,0.8) < 0 ? "分享結果" : "炫耀一下";
      }())]));
   });
   var scoreTextElement = F3(function (seed,marks,total) {
      return A2($Html.p,
      _U.list([$Html$Attributes.$class("score-text")]),
      _U.list([$Html.text(function () {
         var percentage = $Basics.toFloat(marks) / $Basics.toFloat(total);
         if (_U.cmp(percentage,0.4) < 0) {
               var _p0 = A2($Random$Array.sample,seed,$Array.fromList(_U.list(["你完全不認得推友耶","你是來亂的嗎？","你有沒有認真做啊？","認真點做吧"])));
               var maybeString = _p0._0;
               return A2($Maybe.withDefault,"",maybeString);
            } else if (_U.cmp(percentage,0.6) < 0) {
                  var _p1 = A2($Random$Array.sample,seed,$Array.fromList(_U.list(["還好還好","不錯耶"])));
                  var maybeString = _p1._0;
                  return A2($Maybe.withDefault,"",maybeString);
               } else if (_U.cmp(percentage,0.9) < 0) {
                     var _p2 = A2($Random$Array.sample,seed,$Array.fromList(_U.list(["好棒棒","不錯耶"])));
                     var maybeString = _p2._0;
                     return A2($Maybe.withDefault,"",maybeString);
                  } else {
                     var _p3 = A2($Random$Array.sample,seed,$Array.fromList(_U.list(["超準啊！","好神！","好強！","你十分認識推友啊！","厲害"])));
                     var maybeString = _p3._0;
                     return A2($Maybe.withDefault,"",maybeString);
                  }
      }())]));
   });
   var scoreImage = F3(function (seed,marks,total) {
      var percentage = $Basics.toFloat(marks) / $Basics.toFloat(total);
      return _U.cmp(percentage,0.4) < 0 ? A2($Html.img,_U.list([$Html$Attributes.src("/score-bad.png")]),_U.list([])) : _U.cmp(percentage,
      0.8) < 0 ? A2($Html.img,_U.list([$Html$Attributes.src("/score-medium.png")]),_U.list([])) : A2($Html.img,
      _U.list([$Html$Attributes.src("/score-good.png")]),
      _U.list([]));
   });
   var score = function (model) {    return $Array.length(A2($Array.filter,$TwitterTypes.answerCorrect,model.answers));};
   var questionCount = function (model) {
      var totalLength = $Array.length(model.tweets) + $Array.length(model.answers) + function () {
         var _p4 = model.askerModel;
         if (_p4.ctor === "Nothing") {
               return 0;
            } else {
               return 1;
      ...
      return A2($Basics.min,totalLength,20);
   };
   var choose = F2(function (seed,arr) {
      if (_U.eq(arr,$Array.empty)) return {ctor: "_Tuple3",_0: $Maybe.Nothing,_1: seed,_2: arr}; else {
            var intGen = A2($Random.$int,0,$Array.length(arr) - 1);
            var _p5 = A2($Random.generate,intGen,seed);
            var index = _p5._0;
            var seed$ = _p5._1;
            var front = A3($Array.slice,0,index,arr);
            var back = _U.cmp(index + 1,$Array.length(arr)) < 0 ? A3($Array.slice,index + 1,$Array.length(arr),arr) : $Array.empty;
            return {ctor: "_Tuple3",_0: A2($Array.get,index,arr),_1: seed$,_2: A2($Array.append,front,back)};
         }
   });
   var randomUsers$ = F3(function (seed,count,users) {
      if (_U.eq(count,0)) return {ctor: "_Tuple2",_0: $Array.empty,_1: seed}; else {
            var _p6 = A2(choose,seed,users);
            var maybeUser = _p6._0;
            var seed1 = _p6._1;
            var usersLeft = _p6._2;
            var _p7 = maybeUser;
            if (_p7.ctor === "Just") {
                  var _p8 = A3(randomUsers$,seed1,count - 1,usersLeft);
                  var remaining = _p8._0;
                  var seed2 = _p8._1;
                  return {ctor: "_Tuple2",_0: A2($Array.push,_p7._0,remaining),_1: seed2};
               } else {
                  return {ctor: "_Tuple2",_0: $Array.empty,_1: seed1};
               }
         }
   });
   var randomUsers = F3(function (seed,count,users) {    return A3(randomUsers$,seed,count,$Array.fromList($Dict.values(users)));});
   var randomQuestion = function (model) {
      var _p9 = A2(choose,model.seed,model.tweets);
      var maybeTweet = _p9._0;
      var seed1 = _p9._1;
      var newTweets = _p9._2;
      var _p10 = maybeTweet;
      if (_p10.ctor === "Nothing") {
            return {ctor: "_Tuple2",_0: $Maybe.Nothing,_1: model};
         } else {
            var _p13 = _p10._0;
            var _p11 = A3(randomUsers,seed1,3,A2($Dict.remove,_p13.user.screenName,model.users));
            var otherUsers = _p11._0;
            var seed2 = _p11._1;
            var _p12 = A2($Random$Array.shuffle,seed2,A2($Array.push,_p13.user,otherUsers));
            var users = _p12._0;
            var seed3 = _p12._1;
            return {ctor: "_Tuple2",_0: $Maybe.Just(A2($TwitterTypes.Question,_p13,users)),_1: _U.update(model,{tweets: newTweets,seed: seed3})};
         }
   };
   var initAskerModel = function (model) {
      var _p14 = randomQuestion(model);
      var maybeQuestion = _p14._0;
      var newModel = _p14._1;
      var _p15 = maybeQuestion;
      if (_p15.ctor === "Just") {
            var _p16 = $Asker.init(_p15._0);
            var askerModel = _p16._0;
            var askerAction = _p16._1;
            return {ctor: "_Tuple3",_0: $Maybe.Just(askerModel),_1: newModel,_2: askerAction};
         } else {
            return {ctor: "_Tuple3",_0: $Maybe.Nothing,_1: newModel,_2: $Effects.none};
         }
   };
   var usersDict = function (tweets) {
      return $Dict.fromList($Array.toList(A2($Array.map,function (t) {    return {ctor: "_Tuple2",_0: t.user.screenName,_1: t.user};},tweets)));
   };
   var processTweets = F2(function (model,tweets) {
      return _U.update(model,{users: A2($Dict.union,usersDict(tweets),model.users),tweets: A2($Array.append,model.tweets,tweets)});
   });
   var AskerAction = function (a) {    return {ctor: "AskerAction",_0: a};};
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("guesser")]),
      _U.list([function () {
         var _p17 = model.viewState;
         switch (_p17.ctor)
         {case "Loading": return A2($Html.div,_U.list([$Html$Attributes.$class("loading")]),_U.list([$Html.text("等陣...")]));
            case "Playing": var _p18 = model.askerModel;
              if (_p18.ctor === "Just") {
                    return A2($Html.div,
                    _U.list([]),
                    _U.list([A2($Html.div,
                            _U.list([$Html$Attributes.$class("state")]),
                            _U.list([A2($Html.span,
                                    _U.list([$Html$Attributes.$class(A2($Basics._op["++"],$Basics.toString($Array.length(model.answers))," current"))]),
                                    _U.list([$Html.text($Basics.toString($Array.length(model.answers)))]))
                                    ,A2($Html.span,_U.list([]),_U.list([$Html.text("/")]))
                                    ,A2($Html.span,_U.list([$Html$Attributes.$class("total")]),_U.list([$Html.text($Basics.toString(questionCount(model)))]))]))
                            ,A2($Asker.view,A2($Signal.forwardTo,address,AskerAction),_p18._0)]));
                 } else {
                    return A2($Html.div,_U.list([]),_U.list([$Html.text("error: no tweets found")]));
                 }
            case "Errored": return A2($Html.div,_U.list([]),_U.list([$Html.text(A2($Basics._op["++"],"error: ",_p17._0))]));
            default: var total = $Array.length(model.answers);
              var thisScore = score(model);
              return A2($Html.div,
              _U.list([$Html$Attributes.$class("finished")]),
              _U.list([A3(scoreImage,model.seed,thisScore,total)
                      ,A2($Html.p,
                      _U.list([$Html$Attributes.$class("score-text")]),
                      _U.list([$Html.text(A2($Basics._op["++"],$Basics.toString(thisScore),A2($Basics._op["++"],"/",$Basics.toString(total))))]))
                      ,A3(scoreTextElement,model.seed,thisScore,total)
                      ,A2(tweetButton,thisScore,total)]));}
      }()]));
   });
   var Finish = {ctor: "Finish"};
   var Next = {ctor: "Next"};
   var TryToPlay = {ctor: "TryToPlay"};
   var AddTweets = function (a) {    return {ctor: "AddTweets",_0: a};};
   var Load = {ctor: "Load"};
   var ShowError = function (a) {    return {ctor: "ShowError",_0: a};};
   var loadTweets = $Effects.task(A2($Task.onError,
   A2($Task.andThen,
   A2($Http.get,$Json$Decode.list($TwitterTypes.tweet),"/recentTweets"),
   function (tweets) {
      return $Task.succeed(AddTweets($Array.fromList(tweets)));
   }),
   function (error) {
      var _p19 = error;
      switch (_p19.ctor)
      {case "Timeout": return $Task.succeed(ShowError("Timeout"));
         case "NetworkError": return $Task.succeed(ShowError("Network error"));
         case "UnexpectedPayload": return $Task.succeed(ShowError("wrong payload"));
         default: return $Task.succeed(ShowError(A2($Basics._op["++"],"bad response: ",_p19._1)));}
   }));
   var Model = F6(function (a,b,c,d,e,f) {    return {viewState: a,tweets: b,users: c,answers: d,seed: e,askerModel: f};});
   var Finished = {ctor: "Finished"};
   var Errored = function (a) {    return {ctor: "Errored",_0: a};};
   var Playing = {ctor: "Playing"};
   var Loading = {ctor: "Loading"};
   var init = {ctor: "_Tuple2"
              ,_0: {viewState: Loading,tweets: $Array.empty,users: $Dict.empty,answers: $Array.empty,seed: $Random.initialSeed(0),askerModel: $Maybe.Nothing}
              ,_1: loadTweets};
   var update = F2(function (action,model) {
      var _p20 = action;
      switch (_p20.ctor)
      {case "ShowError": return {ctor: "_Tuple2",_0: _U.update(model,{viewState: Errored(_p20._0)}),_1: $Effects.none};
         case "Load": return {ctor: "_Tuple2",_0: _U.update(model,{viewState: Loading}),_1: loadTweets};
         case "AddTweets": return {ctor: "_Tuple2",_0: A2(processTweets,model,_p20._0),_1: $Effects.task($Task.succeed(TryToPlay))};
         case "TryToPlay": if (_U.eq(model.viewState,Playing)) return {ctor: "_Tuple2",_0: model,_1: $Effects.none}; else {
                 var _p21 = model.askerModel;
                 if (_p21.ctor === "Just") {
                       return {ctor: "_Tuple2",_0: _U.update(model,{viewState: Playing}),_1: $Effects.none};
                    } else {
                       return {ctor: "_Tuple2",_0: _U.update(model,{viewState: Playing}),_1: $Effects.task($Task.succeed(Next))};
                    }
              }
         case "Next": if (_U.eq($Array.length(model.answers),questionCount(model))) return {ctor: "_Tuple2"
                                                                                           ,_0: _U.update(model,{viewState: Finished})
                                                                                           ,_1: $Effects.none}; else {
                 var _p22 = initAskerModel(model);
                 var maybeAskerModel = _p22._0;
                 var newModel = _p22._1;
                 var effect = _p22._2;
                 return {ctor: "_Tuple2",_0: _U.update(newModel,{askerModel: maybeAskerModel}),_1: A2($Effects.map,AskerAction,effect)};
              }
         case "AskerAction": var _p23 = model.askerModel;
           if (_p23.ctor === "Nothing") {
                 return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
              } else {
                 var _p24 = A2($Asker.update,_p20._0,_p23._0);
                 var newAskerModel = _p24._0;
                 var askerEffect = _p24._1;
                 var askerResult = $Asker.getResult(newAskerModel);
                 var newAnswers = function () {
                    var _p25 = askerResult;
                    if (_p25.ctor === "Just") {
                          return A2($Array.push,_p25._0,model.answers);
                       } else {
                          return model.answers;
                       }
                 }();
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,{askerModel: $Maybe.Just(newAskerModel),answers: newAnswers})
                        ,_1: $Effects.batch(_U.list([A2($Effects.map,AskerAction,askerEffect)
                                                    ,function () {
                                                       var _p26 = askerResult;
   ...
   return _elm.Guesser.values = {_op: _op,init: init,update: update,view: view,Model: Model};
};
...
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var ShowError = function (a) {    return {ctor: "ShowError",_0: a};};
   var Show = F2(function (a,b) {    return {ctor: "Show",_0: a,_1: b};});
   var getLoginState = $Effects.task(A2($Task.onError,
   A2($Task.andThen,
   A2($Http.get,$Json$Decode.dict($Json$Decode.string),"/loginState"),
   function (result) {
      return $Task.succeed(function () {
         var _p0 = {ctor: "_Tuple3",_0: A2($Dict.get,"loggedIn",result),_1: A2($Dict.get,"login",result),_2: A2($Dict.get,"logout",result)};
         _v0_2: do {
            if (_p0.ctor === "_Tuple3" && _p0._0.ctor === "Just") {
                  switch (_p0._0._0)
                  {case "yes": if (_p0._2.ctor === "Just") {
                             return A2(Show,true,A2($Basics._op["++"],"/auth",_p0._2._0));
                          } else {
                             break _v0_2;
                          }
                     case "no": if (_p0._1.ctor === "Just") {
                             return A2(Show,false,A2($Basics._op["++"],"/auth",_p0._1._0));
                          } else {
                             break _v0_2;
                          }
                     default: break _v0_2;}
         ...
         return ShowError("Unexpected result");
      }());
   }),
   function (error) {
      var _p1 = error;
      ...
      {case "Timeout": return $Task.succeed(ShowError("Timeout"));
         case "NetworkError": return $Task.succeed(ShowError("Network error"));
         case "UnexpectedPayload": return $Task.succeed(ShowError("wrong payload"));
         default: return $Task.succeed(ShowError(A2($Basics._op["++"],"bad response: ",_p1._1)));}
   }));
   var UpdateGuesser = function (a) {    return {ctor: "UpdateGuesser",_0: a};};
   var Load = {ctor: "Load"};
   var Errored = function (a) {    return {ctor: "Errored",_0: a};};
   var LoggedIn = F2(function (a,b) {    return {ctor: "LoggedIn",_0: a,_1: b};});
   var NotLoggedIn = function (a) {    return {ctor: "NotLoggedIn",_0: a};};
   var update = F2(function (action,model) {
      var _p2 = action;
      switch (_p2.ctor)
      {case "Load": return {ctor: "_Tuple2",_0: model,_1: getLoginState};
         case "UpdateGuesser": var _p6 = model;
           if (_p6.ctor === "LoggedIn") {
                 var _p7 = A2($Guesser.update,_p2._0,_p6._0);
                 var newModel = _p7._0;
                 var effect = _p7._1;
                 return {ctor: "_Tuple2",_0: A2(LoggedIn,newModel,_p6._1),_1: A2($Effects.map,UpdateGuesser,effect)};
              } else {
                 return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
              }
         case "Show": if (_p2._0 === true) {
                 var _p5 = _p2._1;
                 var _p3 = model;
                 if (_p3.ctor === "LoggedIn") {
                       return {ctor: "_Tuple2",_0: A2(LoggedIn,_p3._0,_p5),_1: $Effects.none};
                    } else {
                       var _p4 = $Guesser.init;
                       var model = _p4._0;
                       var effect = _p4._1;
                       return {ctor: "_Tuple2",_0: A2(LoggedIn,model,_p5),_1: A2($Effects.map,UpdateGuesser,effect)};
                    }
              } else {
                 return {ctor: "_Tuple2",_0: NotLoggedIn(_p2._1),_1: $Effects.none};
              }
         default: return {ctor: "_Tuple2",_0: Errored(_p2._0),_1: $Effects.none};}
   });
   var Loading = {ctor: "Loading"};
   var init = {ctor: "_Tuple2",_0: Loading,_1: getLoginState};
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("index")]),
      _U.list([function () {
                 var _p8 = model;
                 switch (_p8.ctor)
                 {case "Loading": return A2($Html.div,_U.list([$Html$Attributes.$class("loading")]),_U.list([$Html.text("等陣")]));
                    case "NotLoggedIn": return A2($Html.div,
                      _U.list([$Html$Attributes.$class("welcome")]),
                      _U.list([A2($Html.h1,_U.list([]),_U.list([$Html.text("猜推友")]))
                              ,A2($Html.h2,_U.list([]),_U.list([$Html.text("來看看你有多熟悉你的timeline～")]))
                              ,A2($Html.a,_U.list([$Html$Attributes.href(_p8._0),$Html$Attributes.$class("button")]),_U.list([$Html.text("Authorize")]))]));
                    case "LoggedIn": return A2($Html.div,
                      _U.list([$Html$Attributes.$class("wrapper")]),
                      _U.list([A2($Html.a,_U.list([$Html$Attributes.href(_p8._1),$Html$Attributes.$class("corner")]),_U.list([$Html.text("Switch account")]))
                              ,A2($Guesser.view,A2($Signal.forwardTo,address,UpdateGuesser),_p8._0)]));
                    default: return A2($Html.div,
                      _U.list([$Html$Attributes.$class("loading")]),
                      _U.list([$Html.text(A2($Basics._op["++"],"Error: ",A2($Basics._op["++"],_p8._0," 一定是Twitter的錯！")))]));}
              }()
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("about")]),
              _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("title")]),_U.list([$Html.text("About")]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("me")]),
                      _U.list([$Html.text("By ")
                              ,A2($Html.a,
                              _U.list([$Html$Attributes.href("http://b123400.net"),$Html$Attributes.target("_blank")]),
                              _U.list([$Html.text("b123400.")]))
                              ,$Html.text(" | ")
                              ,A2($Html.a,
                              _U.list([$Html$Attributes.href("http://github.com/b123400/whosetweet"),$Html$Attributes.target("_blank")]),
                              _U.list([$Html.text("Sourcecode here.")]))]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("framework")]),
                      _U.list([$Html.text("Backend written in ")
                              ,A2($Html.a,
                              _U.list([$Html$Attributes.href("https://www.haskell.org"),$Html$Attributes.target("_blank")]),
                              _U.list([$Html.text("Haskell")]))
                              ,$Html.text(", frontend written in ")
                              ,A2($Html.a,
                      ...
                      _U.list([$Html.text("Icons made by ")
                              ,A2($Html.a,
                              _U.list([$Html$Attributes.href("http://www.freepik.com"),$Html$Attributes.target("_blank")]),
                              _U.list([$Html.text("Freepik")]))
                              ,$Html.text(" from ")
                              ,A2($Html.a,
                              _U.list([$Html$Attributes.href("http://www.flaticon.com"),$Html$Attributes.target("_blank")]),
                              _U.list([$Html.text("flaticon")]))
                              ,$Html.text(" is licensed by ")
                              ,A2($Html.a,
                              _U.list([$Html$Attributes.href("http://creativecommons.org/licenses/by/3.0/"),$Html$Attributes.target("_blank")]),
                              _U.list([$Html.text("CC BY 3.0")]))]))]))]));
   });
